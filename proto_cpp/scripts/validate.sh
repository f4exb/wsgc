...
/opt/install/wsgc_test/bin/wsgc_test -s 4096 -d "MFSK:3,0,-32" -t 0.0 -M 2 -R 36 -n -10 -O CC/32/4073739089,3831577671/fano:-1,-8,1,2000000,-4,20000000,-24 >> validate.out
